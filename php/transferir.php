            ...
            <div class="col-md-8">
                <div class="card bg-light" style="width: 600px;">
                    <div class="card-header bg-info text-center">
                        <h4><i class="fas fa-comment-dollar"></i> Transferencia</h4>
                    </div>
                    <div class="card-body">
                        <form action="transferir.php" method="post">
                            ...
                            <label class="col-md-4 col-form-label text-md-right">C/ Origen</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control"  name="origen" readonly value="<?php echo $_SESSION['cuenta']; ?>">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-4 col-form-label text-md-right">C/ Destino</label>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-warning" name="transferir">Transferir</button>
                            </div>
                        </form>
                    </div>
                </div>
